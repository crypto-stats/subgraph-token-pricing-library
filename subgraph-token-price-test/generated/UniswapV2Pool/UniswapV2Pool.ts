...
export class UniswapV2Pool__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2Pool__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UniswapV2Pool extends ethereum.SmartContract {
  static bind(address: Address): UniswapV2Pool {
    return new UniswapV2Pool("UniswapV2Pool", address);
  }
  ...
  burn(to: Address): UniswapV2Pool__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new UniswapV2Pool__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<UniswapV2Pool__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UniswapV2Pool__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): UniswapV2Pool__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new UniswapV2Pool__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<UniswapV2Pool__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2Pool__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
